...
public class UserResourceTest {
  ...
  @Test
    public void testUserPutAccess() {
        given()
          .contentType(ContentType.JSON)
          .header("Authorization", "Bearer " + adminToken)
          .body("{\"firstname\":\"admin\",\"lastname\":\"admin\",\"email\":\"admin@admin.ch\",\"password\":\"admin\",\"role\":{\"id\":1}}")
          .when()
    ...
    @Test
    public void testUserDeleteAccessNegative() {
        given()
          .contentType(ContentType.JSON)
    ...
    @Test
    public void testUserDeleteAccessPositive() {
        given()
          .contentType(ContentType.JSON)
          .header("Authorization", "Bearer " + adminToken)
          .when()
